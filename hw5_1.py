...
cv2.imwrite("img/hw5/tmp1.jpg", ZPX)
...
with tab2:
    ...
    with b2:
        st.image("img/hw5/tmp1.jpg", use_column_width=True, clamp=True, channels="L", caption="Zero Padded Original Image")
        st.image(ZPHtildeDisplay, use_column_width=True, clamp=True,  channels="L", caption="Log-magnitude spectrum H")
        st.image('img/hw5/tmp2.jpg', use_column_width=True, channels="L", clamp= True, caption="Final Filtered Image")
    with b3:
